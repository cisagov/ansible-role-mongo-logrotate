...
issue](https://github.com/cisagov/ansible-role-mongo-logrotate/issues) in
...
request](https://github.com/cisagov/ansible-role-mongo-logrotate/pulls), you
...
```console
cd ansible-role-mongo-logrotate
pyenv virtualenv <python_version_to_use> ansible-role-mongo-logrotate
pyenv local ansible-role-mongo-logrotate
